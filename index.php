...
<head>
    ...
    <title>Home - SK Fingerprint</title>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="banner-slider-content">
                            ...
                            <h1>Next Generation Identity.</h1>
                            <p>
                                At SK Fingerprint, we prioritize your convenience. Whether you choose to drop by one of
                                our
                    ...
                    <div class="col-lg-6">
                        <div class="banner-slider-img">
                            <img src="assets/images/home-two/home-two1.png" alt="Images">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="banner-slider-item">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="banner-slider-img">
                            <img src="assets/images/home-two/home-two2.png" alt="Images">
                        </div>
                    </div>
                </div>
            </div>
...
<div class="services-area-two pt-100 pb-70">
    <div class="container">
        <div class="section-title text-center">
            ...
            <h2>Live scan Fingerprint Service Locations</h2>
        </div>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6 pe-0">
                <div class="about-img-2">
                    <img src="assets/images/about/about-img2.jpg" alt="Images">
                    <div class="about-img-shape">
                        <img src="assets/images/about/about-shape.png" alt="Images">
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="about-content about-content-rs ml-30">
...
<div class="what-did-area-two pt-100 pb-70">
    <div class="container">
        <div class="section-title text-center">
...
<div class="newsletter-area-section">
    <div class="container">
        <div class="container newsletter-area-bg pt-100 pb-70">
            <div class="section-title text-center">
